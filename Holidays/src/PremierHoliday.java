...
public class PremierHoliday {
	public static void main(String[] args){
		Premier hotel1 = new Premier("15/07/2017", "27/07/2017", "Hawaii", "£800", "Excellent", "AJ's Hotel", "Hawaii Resort");
		...
		System.out.println();
		System.out.println(hotel1.getstartDate());
		System.out.println(hotel1.getendDate());
		System.out.println(hotel1.getplace());
